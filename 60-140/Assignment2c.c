#include <stdio.h>
//Michael Morand Section Number: 60-140 Date: Oct 7, 11
int main(void)
{

 int T1, T2, T3, Sum1, Sum2, Sum3, T4;
...
Sum3=((T1*T2)-(T3*T4)%2)/3600;
Sum2=((((T1*T2)-(T3*T4)%2)%3600)/60);
Sum1=((T1*T2)-(T3*T4)/2)%3600)/60);
Sum4=(T1*T2);
Sum5=(Sum4*0.3048);
Sum6=(T3*T4);
Sum7=(Sum6*0.3048);
