...
public class Rectangle extends Shape implements FirstInterface{
 ...
 */
	...
	private Color colorRectangle; // color of a rectangle 
	private Color originalColorRectangle;// Used to save the original color when the color changes temporarily
 ...
 */
	...
	public Rectangle(){
		...
		colorRectangle = new Color(0, 0, 0);  // colour is black
		height = 50;
		width = 50;
	}
	/*
	...
	public void changeColorTemporarily(){	 
		originalColorRectangle = colorRectangle; 
		colorRectangle = Color.yellow ;
		perimeterSelected = true;
	}
	
	public void changeColorBack(){	 
		colorRectangle = originalColorRectangle; 
